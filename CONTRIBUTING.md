...
<sub>~~Also, mainly tested in the following environment. (as of 2026/01/10)~~</sub><br>
~~また、主に下記の環境でテストを行っています。(2026/01/10時点)~~<br>

<sub>- ~~Windows 11 (Build 26200)~~</sub><br>
- ~~Windows 11 (Build 26200)~~<br>

<sub>  - ~~Windows Terminal Beta~~</sub><br>
  - ~~Windows Terminal Beta~~<br>

<sub>  - ~~The following is Config.~~</sub><br>
  - ~~以下はConfigです。~~<br>

<details>
<summary><s>Settings</s></summary>
<pre>
{
    "altGrAliasing": true,
    ...
    "commandline": "\path\to\sshhub_win-x64.exe",
    "cursorShape": "bar",
    "font": 
    {
        "size": 12
    },
    "guid": "{7ff8264c-53eb-4ec6-ae84-78eb650e773a}",
    "hidden": false,
    "historySize": 100000,
    "icon": "\ue977",
    "name": "Connect Server - sshhub",
    "opacity": 72,
    "padding": "8, 8, 8, 8",
    "snapOnInput": true,
...
<sub>Currently, verification is performed based on this setting. (as of 2026/03/11)</sub><br>
現在はこちらの設定に基づいた環境で検証を行っています。(2026/03/11時点)<br>
